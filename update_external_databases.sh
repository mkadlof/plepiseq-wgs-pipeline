...
function show_help() {
    ...
    echo "                  amrfinder_plus mlst cgmlst cgmlstfinder, disinfinder resfinder vfdb enterobase"
    echo "                  kmerfinder metaphlan phiercc pubmlst pointfinder plasmidfinder virulencefinder"
    echo "                  spifindef mlstfinder pangolin nextclade kraken2 freyja all"
...
CORRECT_DB=0
ALL_DB=(amrfinder_plus mlst cgmlst cgmlstfinder, disinfinder resfinder vfdb enterobase kmerfinder metaphlan phiercc pubmlst pointfinder plasmidfinder virulencefinder spifindef mlstfinder pangolin nextclade kraken2 freyja all)
