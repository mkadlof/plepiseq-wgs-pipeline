...
DATABASE="ecoli" # ecoli, yersinia, mcatarrhalis API 2.0
scheme_name="MLST_Achtman" # according to API 2.0 
scheme_dir="Escherichia.Achtman7GeneMLST" # take a look inside https://enterobase.warwick.ac.uk//schemes/ for names of specific schemes
